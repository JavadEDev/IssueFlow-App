...
export default function Navigation() {
  return (
    <aside className="fixed inset-y-0 left-0 w-16 md:w-64 bg-gray-50 dark:bg-[#1A1A1A] border-r border-gray-200 dark:border-dark-border-subtle flex flex-col py-4 px-2 md:px-4">
      <div className="flex items-center justify-center md:justify-start mb-2 px-2">
        <Link
          href="/"
          className="text-xl font-bold tracking-tight text-gray-900 dark:text-white"
        >
          <span className="hidden md:inline">
          <img src="/issueflow-logo.svg" alt="IssueFlow logo" width={120} height={50} className="mb-4" />
          </span>
          <span className="md:hidden">
            <img src="/issueflow-icon.svg" alt="IssueFlow logo" width={120} height={32} className="mb-4" />
          </span>
        </Link>
      </div>
