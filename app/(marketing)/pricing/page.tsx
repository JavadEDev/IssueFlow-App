...
export default function PricingPage() {
  return (
    <div className="container mx-auto px-4 py-12 text-white">
      ...
      <div className="max-w-3xl mx-auto mt-16 text-center bg-slate-800 rounded-lg p-8">
        ...
        <a
          href="mailto:sales@issueflow.com"
          className="inline-flex h-10 items-center justify-center rounded-md bg-purple-600 px-8 py-2 text-sm font-medium text-white shadow transition-colors hover:bg-purple-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-700"
        >
          Contact Sales
        </a>
      </div>
