...
describe('DashboardPage', () => {
  ...
  it('renders the issues list when issues are available', async () => {
    ...
    // Priority labels render twice (desktop + mobile)
    expect(screen.getAllByText(ISSUE_PRIORITY.medium.label)).toHaveLength(2)
    expect(screen.getAllByText(ISSUE_PRIORITY.high.label)).toHaveLength(2)
